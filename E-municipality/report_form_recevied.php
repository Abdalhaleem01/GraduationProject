    ...
    <div class="page-wrapper  bg-white p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680 shadow-sm">
            <div class="card card-1 ms-3" style="text-align:center ;"> 
                ...
                <div class="card-body" >
                    <h2 class="title" style="color:rgb(70, 249, 88);" >شكرًا لك!</h2>
                    <h6>تم استلام نموذج التقرير الخاص بك.
                    <br><br>
                  
                    سنراجع شكواك وسنتعامل معها في أقرب وقت ممكن.
                        <br><br>
                    </h6>
...
<!-- Back to Top -->
<a href="report_form_recevied.php" class="btn btn-lg btn-secondary btn-lg-square rounded back-to-top"><i class="bi bi-arrow-up"></i></a>
    <!-- Jquery JS-->
