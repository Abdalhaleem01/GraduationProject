...
<div class="me-3">
    ...
    <br>
    <ul>
      <li>س1: كيف يمكنني التسجيل في الموقع؟
        ج: يمكنك التسجيل في الموقع من خلال زيارة صفحة التسجيل وملء استمارة التسجيل بالمعلومات المطلوبة، ثم النقر على زر "تسجيل" لإنشاء حساب جديد.</li>
     <br>
        <li>س2: كيف يمكنني العثور على مشاريع البلديات المتاحة؟
            ج: يمكنك العثور على مشاريع البلديات المتاحة من خلال زيارة صفحة "مشاريعنا" في الموقع. ستجد قائمة بالمشاريع الحالية مع تفاصيلها والمعلومات اللازمة للتسجيل أو الاشتراك فيها.</li>
        <br>
        <li>س3: كيف يمكنني تقديم تقييم لخدمة البلدية؟
            ج: يمكنك تقديم تقييم لخدمة البلدية عن طريق زيارة صفحة "رأيك يهمنا" وملء الاستمارة المخصصة. يمكنك تقديم تعليقاتك وتقييماتك وتوصياتك لتحسين الخدمة.</li>
 ...
 <div class="container-fluid bg-dark text-light mt-5 py-5 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <!-- Back to Top -->
    <a href="Q&A.php" class="btn btn-lg btn-secondary btn-lg-square rounded back-to-top"><i
