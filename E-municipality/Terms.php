...
<div class="me-3">
    ...
    <ul>
      <li>قبول الشروط:
        ...
        يعد استخدامك للموقع واعتمادك على محتواه موافقة ضمنية على الشروط والأحكام المذكورة هنا. إذا لم توافق على هذه الشروط، يرجى عدم استخدام الموقع.</li>
     <br>
        <li>المحتوى والملكية الفكرية:

            يحتوي الموقع على محتوى محمي بحقوق الملكية الفكرية، بما في ذلك النصوص والصور والشعارات والعلامات التجارية. يحظر نسخ أو توزيع أو استخدام هذا المحتوى دون إذن كتابي مسبق منا.</li>
        <br>
        <li>الاستخدام المشروع:

            يجب على المستخدمين استخدام الموقع ومحتواه بطريقة قانونية ومشروعة وفقًا للقوانين واللوائح المعمول بها.
            يمنع استخدام الموقع لأغراض غير قانونية أو لنشر أو نقل أو توزيع أو تحميل محتوى غير قانوني أو مسيء أو مسيء للآخرين.</li>
    ...
    <!-- Back to Top -->
    <a href="Terms.php" class="btn btn-lg btn-secondary btn-lg-square rounded back-to-top"><i
