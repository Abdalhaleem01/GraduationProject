            ...
            <div class="container-reg">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title Arabic">إنشاء حساب</h2>
                        
                        <form method="post" class="register-form" id="register-form" action="php/signup2.php">
...
<?php } ?>
                            ...
                            <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="firstname" id="firstname" placeholder="الاسم الأول" value="<?php echo(isset( $_GET['firstname']))?  $_GET['firstname']: "" ?>" Required/>
                                </div>
                                <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="lastname" id="lastname" placeholder=" اسم العائلة" value="<?php echo(isset( $_GET['lastname']))?  $_GET['lastname']: "" ?>" Required/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="re_pass" id="re_pass" placeholder="أعد كتابة كلمة المرور" Required/>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" name="agree-term" id="agree-term" class="agree-term" />
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>أوافق على الشروط  <a href="ListOfPolicies.php" class="term-service">الشروط والأحكام</a></label>
                            </div>
                            <div class="form-group form-button">
                                <input type="submit" name="signup" id="signup" class="form-submit" value="إنشاء حساب"/>
                            </div>
                        </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="images/amman-photo6.jpg" alt="sing up image" style="border-radius:10px;"></figure>
                        <a href="login.php" class="signup-image-link">لدي حساب</a>
                    </div>
                </div>
            </div>
        </section>
 ...
 <div class="container-fluid bg-dark text-light mt-5 py-5 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <!-- Back to Top -->
    <a href="signup.php" class="btn btn-lg btn-secondary btn-lg-square rounded back-to-top"><i class="bi bi-arrow-up"></i></a>
